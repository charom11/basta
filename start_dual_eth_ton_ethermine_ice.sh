...
./teamredminer -a ethash -o stratum+tcp://eu1.ethermine.org:4444 -u 0x02197021fefa795fec661a45f60e47a6f6605281.trmtest -p x --ton -o stratum+tcp://ton.hashrate.to:4002 -u EQAvGYu70uOIrkc8mptTgX7MFO3JJOf9cHpe7ZYJqSLXEWwm.trmtest -p x --ton_end
